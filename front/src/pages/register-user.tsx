    ...
    <>
      {success ? (
        <div className='w-full flex flex-col justify-center items-center' style={{ height: 'calc(100vh - 200px)' }}>        
          ...
          <span>
            Você será redirecionado para a <span className="underline">página inicial</span> em alguns instantes...
          </span>
        </div>
      ) : (
        <div
        ...
        >
          ...
          <div className="w-full">
            {accountType === 'cliente' ? <FormClient setSuccess={setSuccess}/> : <FormBusiness setSuccess={setSuccess}/>}
          </div>
        </div>
      )}
    </>
